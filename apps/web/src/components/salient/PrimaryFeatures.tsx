...
const features = [
  {
    ...
    description:
      "Defend your time. Prioritize and make time for focusing on your most important iniatiaives.",
    image: screenshotPayroll,
  },
  {
    title: 'Context',
    description:
      "Start where you left off. Gain and share context quickly.",
    image: screenshotExpenses,
  },
  {
    title: 'Reflection',
    description:
      "Reflect on your progress, plan ahaead and revise optimize for highest impact.",
    image: screenshotVatReturns,
  },
  {
    title: 'Communication',
    description:
      'Share you progress and reflections. Collaboration is all about communication.',
